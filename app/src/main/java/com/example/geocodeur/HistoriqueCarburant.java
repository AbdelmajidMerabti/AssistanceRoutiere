...
public class HistoriqueCarburant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historique_carburant);


        myRef.orderByChild("libelle").equalTo("Carburant").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                    ...
                    String lettre = "Lettre : "+utilisateur.getType();
            ...
            PanierAdapter adapter = new PanierAdapter(HistoriqueCarburant.this, GlobalList.list_panier);
